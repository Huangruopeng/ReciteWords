...
#include "../../ReciteWordServer/tcpclientsocket.h"
...
QT_MOC_LITERAL(4, 44, 12), // "disconnected"
QT_MOC_LITERAL(5, 57, 12), // "dataReceived"
QT_MOC_LITERAL(6, 70, 16) // "slotDisconnected"

    },
    "TcpClientSocket\0updateClients\0\0"
    "QHostAddress\0disconnected\0dataReceived\0"
    "slotDisconnected"
};
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateClients((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< quint16(*)>(_a[3])),(*reinterpret_cast< QHostAddress(*)>(_a[4]))); break;
        ...
        {
            typedef void (TcpClientSocket::*_t)(QString , int , quint16 , QHostAddress );
...
// SIGNAL 0
void TcpClientSocket::updateClients(QString _t1, int _t2, quint16 _t3, QHostAddress _t4)
{
